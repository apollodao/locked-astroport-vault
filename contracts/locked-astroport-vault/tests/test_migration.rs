...
//     use cw_it::{astroport, ContractType, TestRunner};
...
//             ),
//             astroport_generator: dependencies.astroport_contracts.incentives.address.clone(),
...
//                 &astroport::astroport::generator::QueryMsg::Deposit {
